...
export(Vector2) var tile_size := Vector2(164,42)  # size of a tile in the TileMap
export(int) var NUM_OF_CELLS := 25 # number of points to connect in network
export(int) var DEFAULT_HEIGHT := 75
export(int) var DEFAULT_WIDTH := 75
export(float) var CULL_PERCENT := 0.0

#Road bitmasking replaced with autotile
...
func apply_bitmask():  # replaced with autotile
